    ...
    public void moveObject() {
      ...
      if (isOn && targetMode == TargetMode.Direction) {
        ...
        //Debug.Log("Calling move based on a object");
          directionToMove.x = objectToMoveTowards.transform.position.x - gameObject.transform.position.x;
          directionToMove.y = objectToMoveTowards.transform.position.y - gameObject.transform.position.y;
          directionToMove.z = objectToMoveTowards.transform.position.z - gameObject.transform.position.z;
